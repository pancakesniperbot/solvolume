...
async function handleTrackingAction(action: string, request: Request, url: URL): Promise<Response> {
...
async function handleLicenseRequest(request: Request): Promise<Response> {
...
async function sendTelegramNotification(message: string): Promise<any> {
